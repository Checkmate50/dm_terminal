	...
	for i in range(4):
		for j in range(hoard[i]):
			...
			#Add a potion of appropriate level to the list
				arts.append("Potion:\n" + gen_potion(level+i))
			elif item == "scroll" or (item == "" and random.random() < .25):  #Note that this is a separate random number!!!
			#Add a scroll of appropriate level to the list
				...
				arts.append("Artifact:\n" + artifact[0] + "\n" + "Level: " + str(2*(level+i)-1) + "\tValue: " + artifact[1] + "\tDMG: " + artifact[-1] + att)
	return arts
